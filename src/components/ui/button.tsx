...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "primary-gradient text-primary-foreground hover:shadow-glow hover:-translate-y-0.5",
        secondary: "secondary-gradient text-secondary-foreground hover:shadow-md hover:-translate-y-0.5",
        accent: "accent-gradient text-accent-foreground hover:shadow-md hover:-translate-y-0.5",
        premium: "premium-gradient text-premium-foreground shadow-premium hover:shadow-premium hover:-translate-y-0.5",
        hero: "btn-hero",
