...
-- دالة تسجيل الخروج من جميع الجلسات
CREATE OR REPLACE FUNCTION public.logout_all_admin_sessions(admin_id uuid)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $function$
