...
-- التأكد من تفعيل امتداد pgcrypto
...
-- إعادة إنشاء الدالة مع استخدام صحيح لـ pgcrypto
...
-- إعادة إنشاء دالة التحقق من الجلسة
...
-- التأكد من وجود بيانات المدير مع التشفير الصحيح
